...
namespace Applitools.Tests.Traditional
{
    ...
    public class Traditional_Tablet_V2 : BaseTestClass
    {
        private readonly Browser _browser;
        private readonly Device _device;
        private string resolution = "768x700";
        public Traditional_Tablet_V2(Browser browser, Device device)
        {
            _browser = browser;
            _device = device;
        ...
        public void Task1()
        {
            Assert.Multiple(() =>
            {
                ...
                Assert.IsTrue(reporter.Report(1, "Product Grid Filter Label is Visible", page.HomePage.ProductGridFilterLabel, _browser.ToString(), resolution, _device.ToString(), _driver.Displayed(page.HomePage.ProductGridFilterLabel)));
