...
namespace Applitools.Tests.Traditional
{
    ...
    [Category("traditional2")]
    public class Traditional_Phone_V2 : BaseTestClass
    {
        private readonly Browser _browser;
        private readonly Device _device;
        private string resolution = "500x700";
        public Traditional_Phone_V2(Browser browser, Device device)
        {
            _browser = browser;
            _device = device;
        ...
        public void Task1()
        {
            Assert.Multiple(() =>
            {
                ...
                Assert.IsTrue(reporter.Report(1, "Favorites Icon is NOT Visible", page.HeaderPage.FavoritesIcon, _browser.ToString(), resolution, _device.ToString(), !_driver.Displayed(page.HeaderPage.FavoritesIcon)));
                ...
                Assert.IsTrue(reporter.Report(1, "Bag Count is NOT Visible", page.HeaderPage.BagCount, _browser.ToString(), resolution, _device.ToString(), !_driver.Displayed(page.HeaderPage.BagCount)));
                Assert.IsTrue(reporter.Report(1, "Main Menu is NOT Visible", page.HeaderPage.MainMenu, _browser.ToString(), resolution, _device.ToString(), !_driver.Displayed(page.HeaderPage.MainMenu)));

                //Verify Search Bar
                Assert.IsTrue(reporter.Report(1, "Search Field is NOT Visible", page.HeaderPage.SearchField, _browser.ToString(), resolution, _device.ToString(), !_driver.Displayed(page.HeaderPage.SearchField)));
                Assert.IsTrue(reporter.Report(1, "Search Icon Desktop is NOT Visible", page.HeaderPage.SearchIcon, _browser.ToString(), resolution, _device.ToString(), !_driver.Displayed(page.HeaderPage.SearchIcon)));
                Assert.IsTrue(reporter.Report(1, "Search Icon Mobile is Visible", page.HeaderPage.SearchIconMobile, _browser.ToString(), resolution, _device.ToString(), _driver.Displayed(page.HeaderPage.SearchIconMobile)));

                //Verify Grid Filter
                Assert.IsTrue(reporter.Report(1, "Left Grid Filter Section is NOT Visible", page.HomePage.SidebarGridFilter, _browser.ToString(), resolution, _device.ToString(), !_driver.Displayed(page.HomePage.SidebarGridFilter)));
                ...
                Assert.IsTrue(reporter.Report(1, "Product Grid Filter Icon is Visible", page.HomePage.ProductGridFilterIcon, _browser.ToString(), resolution, _device.ToString(), _driver.Displayed(page.HomePage.ProductGridFilterIcon)));
                ...
                Assert.IsTrue(reporter.Report(1, "Product Grid Filter>Grid View Icon is NOT Visible", page.HomePage.ProductGridFilterGridViewIcon, _browser.ToString(), resolution, _device.ToString(), !_driver.Displayed(page.HomePage.ProductGridFilterGridViewIcon)));
                Assert.IsTrue(reporter.Report(1, "Product Grid Filter>List View Icon is NOT Visible", page.HomePage.ProductGridFilterListViewIcon, _browser.ToString(), resolution, _device.ToString(), !_driver.Displayed(page.HomePage.ProductGridFilterListViewIcon)));
                ...
                Assert.IsTrue(reporter.Report(1, "Product Card Favorite Icon is Visible", page.HomePage.ProductCardFavoriteIcon, _browser.ToString(), resolution, _device.ToString(), _driver.Displayed(page.HomePage.ProductCardFavoriteIcon)));
                Assert.IsTrue(reporter.Report(1, "Product Card Shuffle Icon is Visible", page.HomePage.ProductCardShuffleIcon, _browser.ToString(), resolution, _device.ToString(), _driver.Displayed(page.HomePage.ProductCardShuffleIcon)));
                Assert.IsTrue(reporter.Report(1, "Product Card Shopping Cart Icon is Visible", page.HomePage.ProductCardShoppingCartIcon, _browser.ToString(), resolution, _device.ToString(), _driver.Displayed(page.HomePage.ProductCardShoppingCartIcon)));
                ...
                Assert.IsTrue(reporter.Report(1, "Footer Quick Links Section is NOT Visible", page.FooterPage.FooterQuickLinksSection, _browser.ToString(), resolution, _device.ToString(), !_driver.Displayed(page.FooterPage.FooterQuickLinksSection)));
                Assert.IsTrue(reporter.Report(1, "Footer Contacts Section is NOT Visible", page.FooterPage.FooterContactsSection, _browser.ToString(), resolution, _device.ToString(), !_driver.Displayed(page.FooterPage.FooterContactsSection)));
                Assert.IsTrue(reporter.Report(1, "Footer Keep In Touch Section is NOT Visible", page.FooterPage.FooterKeepInTouchSection, _browser.ToString(), resolution, _device.ToString(), !_driver.Displayed(page.FooterPage.FooterKeepInTouchSection)));
            });
        }
